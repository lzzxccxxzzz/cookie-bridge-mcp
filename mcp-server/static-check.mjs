...
const files = ['start.js', 'mod_api/main.js', 'mod_api/control-schema.js', 'mod_api/control-runtime.js', 'mod_api/control-queue.js', 'mcp-server/server.mjs', 'mcp-server/static-check.mjs'];
